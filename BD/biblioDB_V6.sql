...
INSERT INTO `copias` VALUES (1,1,2,1,'4','4','4'),(2,1,2,2,'2','5','6'),(3,1,4,3,'3','2','2'),(4,1,2,4,NULL,NULL,NULL),(5,2,1,1,NULL,NULL,NULL),(6,2,2,2,'2','2','2'),(7,3,2,1,'1','1','1'),(8,3,1,2,'2','2','2'),(9,3,1,3,NULL,NULL,NULL),(10,4,1,1,NULL,NULL,NULL),(11,4,1,2,NULL,NULL,NULL),(12,4,1,3,NULL,NULL,NULL),(13,5,2,1,'1','1','1'),(14,5,2,2,'3','4','3'),(15,6,4,1,'1','3','1'),(16,6,2,2,'22','45','3'),(17,6,1,3,'2','2','3'),(18,7,1,1,NULL,NULL,NULL),(19,8,1,1,NULL,NULL,NULL),(20,9,1,1,NULL,NULL,NULL),(21,10,1,1,NULL,NULL,NULL),(22,11,1,1,NULL,NULL,NULL),(23,12,1,1,NULL,NULL,NULL),(24,13,2,1,'2','1','1'),(25,14,1,1,NULL,NULL,NULL),(26,15,1,1,NULL,NULL,NULL),(27,20,3,1,'22','4','44'),(28,21,3,1,'2','2','3'),(29,21,1,2,NULL,NULL,NULL),(30,21,3,3,'2','3','1'),(31,21,1,4,NULL,NULL,NULL),(32,21,4,5,'2','2','2'),(33,21,5,6,'2','22','2'),(34,21,2,7,'2','22','2'),(35,21,2,8,'1','1','2'),(36,21,2,9,'2','1','3'),(37,22,2,1,'1','2','2'),(38,22,2,2,'1','1','1'),(39,22,2,3,'2','2','2'),(40,22,2,4,'2','2','2'),(41,23,2,1,'2','3','4'),(42,23,2,2,'2','3','4'),(43,23,2,3,'3','5','6'),(44,23,2,4,'2','3','4'),(45,23,1,5,NULL,NULL,NULL),(46,23,1,6,NULL,NULL,NULL),(47,24,6,1,'3','3','3'),(48,24,2,2,'2','2','3'),(49,24,2,3,'3','2','1'),(50,24,2,4,'3','3','3'),(51,24,2,5,'3','2','2'),(52,24,2,6,'2','2','2'),(53,24,1,7,NULL,NULL,NULL),(54,24,1,8,NULL,NULL,NULL),(55,25,2,1,'2','1','4'),(56,25,2,2,'2','1','3'),(57,25,2,3,'2','1','3'),(58,26,2,1,'2','2','1'),(59,26,2,2,'2','1','2'),(60,26,2,3,'1','1','2'),(61,26,2,4,'2','2','1'),(62,27,2,1,'3','3','3'),(63,27,2,2,'1','1','1'),(64,27,2,3,'2','34','4'),(65,27,2,4,'3','2','3'),(66,27,1,5,NULL,NULL,NULL),(67,28,6,1,'2','2','2'),(68,28,2,2,'2','2','2'),(69,28,2,3,'2','2','2'),(70,29,1,1,NULL,NULL,NULL),(71,29,1,2,NULL,NULL,NULL),(72,29,1,3,NULL,NULL,NULL),(73,29,1,4,NULL,NULL,NULL),(74,29,1,5,NULL,NULL,NULL),(75,29,1,6,NULL,NULL,NULL),(76,29,1,7,NULL,NULL,NULL),(77,30,1,1,NULL,NULL,NULL),(78,30,1,2,NULL,NULL,NULL),(79,30,1,3,NULL,NULL,NULL),(80,30,1,4,NULL,NULL,NULL),(81,30,1,5,NULL,NULL,NULL),(82,30,1,6,NULL,NULL,NULL),(83,30,1,7,NULL,NULL,NULL),(84,30,1,8,NULL,NULL,NULL),(85,31,1,1,NULL,NULL,NULL),(86,31,1,2,NULL,NULL,NULL),(87,31,1,3,NULL,NULL,NULL),(88,31,1,4,NULL,NULL,NULL),(89,31,1,5,NULL,NULL,NULL);
...
CREATE TABLE `prestamos` (
  ...
  KEY `prestamo_usu_idx` (`usu_ID`),
  CONSTRAINT `prestamo_libro` FOREIGN KEY (`lib_ID`) REFERENCES `libros` (`lib_ID`),
  CONSTRAINT `prestamo_usu` FOREIGN KEY (`usu_ID`) REFERENCES `usuarios` (`usu_ID`)
...
INSERT INTO `prestamos` VALUES (2,1,1,1,'0000-00-00 00:00:00','0000-00-00 00:00:00'),(4,1,4,21,'2017-11-02 17:10:32','2017-11-07 00:00:00');
...
INSERT INTO `reservas` VALUES (2,1,24,47,'2017-11-01 18:14:09','2017-11-04 00:00:00',0),(3,1,28,67,'2017-11-01 18:14:19','2017-11-04 00:00:00',0),(4,1,21,28,'2017-11-01 18:14:53','2017-11-04 00:00:00',1);
...
CREATE TABLE `sanciones` (
  ...
  CONSTRAINT `sancion_usu` FOREIGN KEY (`usu_ID`) REFERENCES `usuarios` (`usu_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuarios` VALUES (0,3,'Victor Martinez','vimartinez','123456','2017-10-27 00:00:00',NULL,'Morenou 845','barrio','Temperley',1,'mail@gmail.com','23234234',1),(1,1,'Victor Martinez','vic','victor','2017-10-01 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,'25987147',0),(2,3,'Victor Martinez','vimartinez','123456','2017-10-27 17:39:37',NULL,'Matheu 845','barrio','Banfield',1,'victordmart@gmail.com','23234234',1),(3,3,'Victor Martinez','vimartinez','123456','2017-10-27 17:40:09',NULL,'Matheu 845','barrio','Banfield',1,'victordmart@gmail.com','23234234',1),(4,3,'Lautaro','lauti','1234qwer','2017-10-27 18:00:52',NULL,'La florida','Los Tulipanes','Morón',1,'lau@gmail.com','2312342',0),(5,3,'Santiago','santi','1234qwer','2017-10-27 18:03:29',NULL,'Lavalleja','','Florencio Varela',1,'santi@gmail.com','33234321',0),(6,2,'Operador','operador','1234qwer','2017-10-27 18:03:29',NULL,'Mariano moreno 543',NULL,NULL,2,'operador@gmail.com',NULL,0),(7,3,'Socio','socio','12345678','2017-11-01 14:43:13',NULL,'Las tarlipes 845','Luján de Cuyo','Morón',24,'socio@gmail.com','1243234',0),(8,3,'Socio','socio','12345678','2017-11-01 14:44:45',NULL,'Las tarlipes 845','Luján de Cuyo','Morón',24,'socio@gmail.com','1243234',1);
...
-- Dump completed on 2017-11-02 18:18:29
