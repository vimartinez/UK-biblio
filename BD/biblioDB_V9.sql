...
INSERT INTO `autores` VALUES (1,'Stephen King',75,0),(18,'Michael Crichton',75,0),(19,'Mario Puzo',75,0),(21,'Dan Brown',75,0),(22,'Robert Harris',75,0),(23,'Dan Brown 2',75,1),(24,'Wilbur Smith',75,0),(25,'Santiago Posteguillo',73,0),(26,'Javier Negrete',73,0),(27,'J R R Tolkien',180,0),(28,'JK Rowling',180,0),(29,'Valerio Massimo Manfredi',112,0),(30,'Gerorge R R Martin',180,0),(31,'Felipe Pigna',13,0);
...
CREATE TABLE `catalogo` (
  ...
  PRIMARY KEY (`cat_ID`),
  KEY `catalogo_libro_idx` (`lib_ID`),
  CONSTRAINT `catalogo_libro` FOREIGN KEY (`lib_ID`) REFERENCES `libros` (`lib_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `copias` (
  ...
  KEY `copia_libro_idx` (`lib_ID`),
  CONSTRAINT `copia_estado` FOREIGN KEY (`est_ID`) REFERENCES `estados_libros` (`est_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `copia_libro` FOREIGN KEY (`lib_ID`) REFERENCES `libros` (`lib_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `copias` VALUES (1,1,6,1,'4','4','4'),(2,1,6,2,'2','5','6'),(3,1,4,3,'3','2','2'),(4,1,2,4,NULL,NULL,NULL),(5,2,1,1,NULL,NULL,NULL),(6,2,2,2,'2','2','2'),(7,3,6,1,'1','1','1'),(8,3,1,2,'2','2','2'),(9,3,1,3,NULL,NULL,NULL),(10,4,1,1,NULL,NULL,NULL),(11,4,1,2,NULL,NULL,NULL),(12,4,1,3,NULL,NULL,NULL),(13,5,3,1,'1','1','1'),(14,5,2,2,'3','4','3'),(15,6,4,1,'1','3','1'),(16,6,2,2,'22','45','3'),(17,6,1,3,'2','2','3'),(18,7,1,1,NULL,NULL,NULL),(19,8,1,1,NULL,NULL,NULL),(20,9,1,1,NULL,NULL,NULL),(21,10,1,1,NULL,NULL,NULL),(22,11,1,1,NULL,NULL,NULL),(23,12,1,1,NULL,NULL,NULL),(24,13,6,1,'2','1','1'),(25,14,1,1,NULL,NULL,NULL),(26,15,1,1,NULL,NULL,NULL),(27,20,2,1,'22','4','44'),(28,21,3,1,'2','2','3'),(29,21,1,2,NULL,NULL,NULL),(30,21,6,3,'2','3','1'),(31,21,1,4,NULL,NULL,NULL),(32,21,4,5,'2','2','2'),(33,21,5,6,'2','22','2'),(34,21,6,7,'2','22','2'),(35,21,6,8,'1','1','2'),(36,21,2,9,'2','1','3'),(37,22,6,1,'1','2','2'),(38,22,2,2,'1','1','1'),(39,22,2,3,'2','2','2'),(40,22,2,4,'2','2','2'),(41,23,3,1,'2','3','4'),(42,23,6,2,'2','3','4'),(43,23,2,3,'3','5','6'),(44,23,2,4,'2','3','4'),(45,23,1,5,NULL,NULL,NULL),(46,23,1,6,NULL,NULL,NULL),(47,24,6,1,'3','3','3'),(48,24,6,2,'2','2','3'),(49,24,6,3,'3','2','1'),(50,24,3,4,'3','3','3'),(51,24,2,5,'3','2','2'),(52,24,2,6,'2','2','2'),(53,24,1,7,NULL,NULL,NULL),(54,24,1,8,NULL,NULL,NULL),(55,25,3,1,'2','1','4'),(56,25,2,2,'2','1','3'),(57,25,2,3,'2','1','3'),(58,26,6,1,'2','2','1'),(59,26,6,2,'2','1','2'),(60,26,2,3,'1','1','2'),(61,26,2,4,'2','2','1'),(62,27,6,1,'3','3','3'),(63,27,2,2,'1','1','1'),(64,27,2,3,'2','34','4'),(65,27,2,4,'3','2','3'),(66,27,1,5,NULL,NULL,NULL),(67,28,6,1,'2','2','2'),(68,28,2,2,'2','2','2'),(69,28,2,3,'2','2','2'),(70,29,1,1,NULL,NULL,NULL),(71,29,3,2,'5','3','3'),(72,29,1,3,NULL,NULL,NULL),(73,29,1,4,NULL,NULL,NULL),(74,29,1,5,NULL,NULL,NULL),(75,29,1,6,NULL,NULL,NULL),(76,29,1,7,NULL,NULL,NULL),(77,30,1,1,NULL,NULL,NULL),(78,30,1,2,NULL,NULL,NULL),(79,30,1,3,NULL,NULL,NULL),(80,30,1,4,NULL,NULL,NULL),(81,30,1,5,NULL,NULL,NULL),(82,30,1,6,NULL,NULL,NULL),(83,30,1,7,NULL,NULL,NULL),(84,30,1,8,NULL,NULL,NULL),(85,31,1,1,NULL,NULL,NULL),(86,31,1,2,NULL,NULL,NULL),(87,31,1,3,NULL,NULL,NULL),(88,31,1,4,NULL,NULL,NULL),(89,31,1,5,NULL,NULL,NULL),(90,32,6,1,'2','1','2'),(91,32,3,2,'2','34','4'),(92,32,6,3,'4','3','2'),(93,32,6,4,'3','2','1'),(94,32,3,5,'3','2','1'),(95,32,2,6,'3','2','1'),(96,32,2,7,'3','2','3'),(97,32,1,8,NULL,NULL,NULL),(98,33,1,1,NULL,NULL,NULL),(99,33,3,2,'3','3','3'),(100,33,2,3,'3','3','3'),(101,33,2,4,'2','3','4'),(102,33,1,5,NULL,NULL,NULL),(103,34,6,1,'2','2','2'),(104,34,2,2,'3','1','2'),(105,34,2,3,'3','2','3'),(106,34,1,4,NULL,NULL,NULL),(107,34,1,5,NULL,NULL,NULL),(108,34,1,6,NULL,NULL,NULL),(109,35,6,1,'1','23','3'),(110,35,1,2,NULL,NULL,NULL),(111,35,6,3,'2','2','3'),(112,35,2,4,'3','3','2'),(113,35,2,5,'3','3','3');
...
INSERT INTO `estados_libros` VALUES (1,'Ingresado'),(2,'Disponible'),(3,'Prestado'),(4,'Dañado'),(5,'Perdido - Robado'),(6,'Reservado');
...
CREATE TABLE `libros` (
  ...
  `eliminado` tinyint(4) DEFAULT '0',
  PRIMARY KEY (`lib_ID`),
  KEY `libros_autores_idx` (`aut_ID`),
  CONSTRAINT `libros_autores` FOREIGN KEY (`aut_ID`) REFERENCES `autores` (`aut_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `libros` VALUES (1,1,'9781444707861','IT','Novela','Terror','Ediciones B','null',4,0),(2,18,'33982899','Alexandros','Novela','Historica','Alfahuara','Vida de Alejandro Magno ',2,1),(3,19,'994838832','El Padrino','Novela','Suspenso','Pala','Novela de Mafia',3,0),(4,19,'','sd','','','','',3,1),(5,1,'99483234','El Resplandor','Novela','Terror','','Un cuidador se queda con su familia durante en el invierno trabajando en un hotel asilado por la nieve y empieza a enloquecer cuando descubre que en hotel existen otras cosas,',2,0),(6,18,'9765757588','Paladion','Novela histórica','','','El paladion cae del cielo y la diosa Atenea emprende una misión para encontrarlo junto con unos mortales en la época moderna.',3,1),(7,1,'','La hora del Vampiro','','','','',1,1),(8,1,'','La hora del Vampiro','','','','',1,1),(9,1,'','La hora del Vampiro','','','','',1,1),(10,1,'','La hora del Vampiro','','','','',1,1),(11,1,'','La hora del Vampiro','','','','',1,1),(12,1,'','La hora del Vampiro','','','','',1,1),(13,1,'','La hora del Vampiro','','','','',1,0),(14,1,'','La hora del Vampiro','','','','',1,1),(15,1,'','La hora del Vampiro','','','','',1,1),(16,1,'El ojo del tibre','Aventura','','','','',2,1),(17,1,'ojo tigre','Aventur','ee','momo','s','',3,1),(18,1,'nombre libro','género','subgénero','editorial','reseña','',3,1),(19,21,'isbn','nombre libro','genero','subgenero','editorial','reseña',4,1),(20,21,'99988932233','El código Da vinci','Novela','Aventura','Minotauro','',10,1),(21,21,'98983272','El código Da vinci','Novela','Aventura','Minotauro','',9,0),(22,1,'998898988','Maleficio','Novela','Terror','','Una maldición de un gitano cambia totalmente la vida de un funcionario adinerado.',4,0),(23,25,'98879877','Africanus','Novela histórica','','Ediciones B','Primera parte de la trilogía Escipión de Santiago Posteguillo',6,0),(24,25,'7889799999','Las legiones malditas','Novela histórica','','Ediciones B','Segunda parte de la trilogía Escipión',8,0),(25,25,'99898999','La traición de Roma','Novela histórica','','Ediciones B','Tercera parte de la trilogía Escipión.',3,0),(26,29,'99898999','Talos de Esparta','Novela histórica','Esparta','Alfahuara','Talos es un esclavo Ilota que se ve involucrado en una histórica batalla mientras está bajo el mando de un aristócrata espartano.',4,0),(27,29,'999898999','El oráculo','Novela','','','',5,0),(28,18,'','Presa','Novela','','','Una serie de nanorobots se salen de control en un experimento tecnológico.',3,0),(29,27,'889879878','El señor de los Anillos I','Fantasía','Épica','Minotauro','La comunidad del anillo',7,0),(30,27,'','El señor de los Anillos II','Fantasía','É','','',8,0),(31,27,'','El señor de los Anillos III','f','','','',5,0),(32,1,'998798789','Misery','Novela','Terror','Ediciones B','Un escritor sufre un accidente y es cuidado por una enfermera fanática que lo obliga a escribir un nuevo libro.',8,0),(33,31,'98898998','Los mitos de la historia','No ficción','Historica','Minotauro','Volumen 1 de los mitos',5,0),(34,31,'88897897','Los mitos II','No ficción','Historica','Minotauro','Segunda parte de Los Mitos.',6,0),(35,19,'9898889','El último Don','Novela','Mafia','Salamandra','',5,0);
...
INSERT INTO `perf_funcionalidad` VALUES (1,1,1,0),(2,1,2,0),(3,1,3,0),(4,2,3,1),(5,1,4,0),(6,3,4,0),(7,2,4,1),(8,1,5,0),(9,1,6,0),(10,1,7,0),(11,1,8,0),(12,1,9,0),(13,1,10,1),(14,1,11,0),(17,3,7,0),(18,2,1,0),(19,2,2,0),(20,2,3,0),(21,2,4,0),(22,2,5,0),(23,2,6,0),(24,2,7,0),(25,1,14,0),(26,2,14,0),(27,1,12,0),(28,1,13,1);
...
CREATE TABLE `prestamos` (
  ...
  KEY `prestamo_libro_idx` (`lib_ID`),
  KEY `prestamo_copia_idx` (`cop_ID`),
  KEY `prestamo_usuario_idx` (`usu_ID`),
  CONSTRAINT `prestamo_copia` FOREIGN KEY (`cop_ID`) REFERENCES `copias` (`cop_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `prestamo_libro` FOREIGN KEY (`lib_ID`) REFERENCES `libros` (`lib_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `prestamo_usuario` FOREIGN KEY (`usu_ID`) REFERENCES `usuarios` (`usu_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `prestamos` VALUES (7,1,NULL,21,28,'2017-11-03 12:05:53','2017-11-08 00:00:00',0),(8,1,4,21,28,'2017-11-03 12:06:18','2017-11-08 00:00:00',0),(9,1,8,33,100,'2017-11-03 17:56:16','2017-11-08 00:00:00',1),(10,1,10,32,91,'2017-11-01 20:09:40','2017-11-02 00:00:00',0),(11,5,NULL,5,13,'2017-11-03 20:10:16','2017-11-08 00:00:00',0),(12,1,6,33,99,'2017-11-05 18:26:53','2017-11-10 00:00:00',0),(13,9,NULL,24,50,'2017-11-05 18:34:46','2017-11-10 00:00:00',0),(14,7,NULL,25,55,'2017-11-05 18:46:12','2017-11-10 00:00:00',0),(15,1,NULL,32,94,'2017-11-05 19:07:49','2017-11-10 00:00:00',0),(16,1,17,23,41,'2017-11-09 19:51:58','2017-11-14 00:00:00',0),(17,1,18,29,71,'2017-11-09 20:16:06','2017-11-14 00:00:00',0);
...
CREATE TABLE `reservas` (
  ...
  PRIMARY KEY (`res_ID`),
  KEY `reserva_libro_idx` (`lib_ID`),
  KEY `reserva_copia_idx` (`cop_id`),
  KEY `reserva_usuario_idx` (`usu_ID`),
  CONSTRAINT `reserva_copia` FOREIGN KEY (`cop_id`) REFERENCES `copias` (`cop_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `reserva_libro` FOREIGN KEY (`lib_ID`) REFERENCES `libros` (`lib_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `reserva_usuario` FOREIGN KEY (`usu_ID`) REFERENCES `usuarios` (`usu_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `reservas` VALUES (2,1,24,47,'2017-11-01 18:14:09','2017-11-04 00:00:00',0,0),(3,1,28,67,'2017-11-01 18:14:19','2017-11-04 00:00:00',0,0),(4,1,21,28,'2017-11-01 18:14:53','2017-11-04 00:00:00',1,0),(5,1,32,90,'2017-11-03 16:51:17','2017-11-06 00:00:00',0,0),(6,1,33,99,'2017-11-03 17:13:15','2017-11-06 00:00:00',1,0),(7,1,34,103,'2017-11-03 17:24:03','2017-11-06 00:00:00',0,0),(8,1,33,100,'2017-11-03 17:24:13','2017-11-06 00:00:00',1,0),(9,4,21,30,'2017-11-03 17:57:53','2017-11-06 00:00:00',0,0),(10,1,32,91,'2017-11-03 20:09:16','2017-11-06 00:00:00',1,0),(11,4,24,48,'2017-11-03 20:28:42','2017-11-06 00:00:00',0,0),(12,4,32,92,'2017-11-03 20:28:51','2017-11-06 00:00:00',0,0),(13,9,32,93,'2017-11-05 18:32:29','2017-11-08 00:00:00',0,0),(14,9,26,58,'2017-11-05 18:32:37','2017-11-08 00:00:00',0,1),(15,6,24,49,'2017-11-05 18:33:33','2017-11-08 00:00:00',0,0),(16,6,35,109,'2017-11-05 18:33:41','2017-11-08 00:00:00',0,0),(17,1,23,41,'2017-11-09 18:58:52','2017-11-12 00:00:00',1,0),(18,1,29,71,'2017-11-09 19:49:39','2017-11-12 00:00:00',1,0),(19,7,1,1,'2017-11-09 19:52:45','2017-11-12 00:00:00',0,0),(20,7,1,2,'2017-11-09 19:52:54','2017-11-12 00:00:00',0,0),(21,7,3,7,'2017-11-09 19:52:57','2017-11-12 00:00:00',0,1),(22,7,13,24,'2017-11-09 19:53:01','2017-11-12 00:00:00',0,0),(23,7,21,34,'2017-11-09 19:53:04','2017-11-12 00:00:00',0,0),(24,7,21,35,'2017-11-09 19:53:07','2017-11-12 00:00:00',0,0),(25,7,23,42,'2017-11-09 19:53:10','2017-11-12 00:00:00',0,0),(26,7,26,59,'2017-11-09 19:53:13','2017-11-12 00:00:00',0,1),(27,1,22,37,'2017-11-12 12:43:40','2017-11-15 00:00:00',0,0),(28,1,27,62,'2017-11-12 12:43:46','2017-11-15 00:00:00',0,0),(29,7,28,67,'2017-11-12 12:48:07','2017-11-15 00:00:00',0,0),(30,7,35,111,'2017-11-12 12:48:11','2017-11-15 00:00:00',0,0);
...
CREATE TABLE `sanciones` (
  ...
  PRIMARY KEY (`san_ID`),
  UNIQUE KEY `san_ID_UNIQUE` (`san_ID`),
  KEY `sancion_tipo` (`tip_ID`),
  KEY `sancion_prestamo_idx` (`pres_ID`),
  KEY `sancion_usuario_idx` (`usu_ID`),
  CONSTRAINT `sancion_prestamo` FOREIGN KEY (`pres_ID`) REFERENCES `prestamos` (`pres_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `sancion_tipo` FOREIGN KEY (`tip_ID`) REFERENCES `tipos_sanciones` (`tip_ID`),
  CONSTRAINT `sancion_usuario` FOREIGN KEY (`usu_ID`) REFERENCES `usuarios` (`usu_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `sanciones` VALUES (1,NULL,1,1,'2017-11-04 00:00:00','2017-11-04 00:00:00'),(2,NULL,1,1,'2017-11-04 20:53:42','2017-11-09 00:00:00'),(3,NULL,1,1,'2017-11-05 17:13:58','2017-11-20 00:00:00'),(4,NULL,1,4,'2017-11-05 17:14:41','2018-01-04 00:00:00'),(5,NULL,1,1,'2017-11-05 19:12:00','2017-12-05 00:00:00'),(6,NULL,1,1,'2017-11-09 20:14:29','2018-02-07 00:00:00');
...
INSERT INTO `usuarios` VALUES (1,1,'Victor Martinez','vic','victor','2017-10-01 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,'25987147',0),(2,3,'Victor Martinez','vimartinez','123456','2017-10-27 17:39:37',NULL,'Matheu 845','barrio','Banfield',1,'victordmart@gmail.com','23234234',1),(3,3,'Victor Martinez','vimartinez','123456','2017-10-27 17:40:09',NULL,'Matheu 845','barrio','Banfield',1,'victordmart@gmail.com','23234234',1),(4,3,'Lautaro','lauti','1234qwer','2017-10-27 18:00:52',NULL,'La florida','Los Tulipanes','Morón',1,'lau@gmail.com','2312342',0),(5,3,'Santiago','santi','1234qwer','2017-10-27 18:03:29',NULL,'Lavalleja','','Florencio Varela',1,'santi@gmail.com','33234321',0),(6,2,'Operador','operador','1234qwer','2017-10-27 18:03:29',NULL,'Mariano moreno 543',NULL,NULL,2,'operador@gmail.com',NULL,0),(7,3,'Socio','socio','1234qwer','2017-11-01 14:43:13',NULL,'Las tarlipes 845','Luján de Cuyo','Morón',24,'socio@gmail.com','1243234',0),(8,3,'Socio','socio','12345678','2017-11-01 14:44:45',NULL,'Las tarlipes 845','Luján de Cuyo','Morón',24,'socio@gmail.com','1243234',1),(9,3,'Otro Socio','socio2','1234qwer','2017-11-03 17:21:06',NULL,'San Martin','Lugano','CABA',3,'socio2@gmail.com','2033454',1),(10,2,'Usuario','usu','1234qwer','2017-11-05 19:55:34',NULL,'Calle 2','barrio','localidad',1,'usuario@gmail.com','20387327',0),(11,3,'Dan Brown','er','123456','2017-11-09 20:01:42',NULL,'aaaaaaaaaa','aaaaaaa','El Rodeo',9,'ern@yahoo.com','12345678',0);
...
-- Dump completed on 2017-11-12 16:49:49
